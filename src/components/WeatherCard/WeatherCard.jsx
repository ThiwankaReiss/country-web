                ...
                <div className="col-lg-12 col-md-12">
                    <div className="container card addShadow ">
                        <div className="row">
                            ...
                            <div className="col-lg-3 col-md-3 justify-content-end align-self-center">
                            ...
                            <div className="col-lg-3 col-md-3 justify-content-center align-items-center">
                                <div>
                                    <p className='m-0 p-0'>
                    ...
                    <div className="container card addShadow mt-2">
                        <div className="row">
                            ...
                            <div className="col-lg-3 col-md-3 justify-content-center align-self-center">
                                <div>
                                    <p className='m-0 p-0 '>
                            ...
                            <div className="col-lg-12 col-md-12"><hr></hr></div>
                            <div className="col-lg-12 col-md-12">
